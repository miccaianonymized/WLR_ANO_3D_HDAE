...
from trainer_ddim_hdae_seg import run_ddim_hdae_training_seg
from data_utils_seg import get_loader
...
def main_worker_enc(args):
    ...
    os.makedirs(args.log_dir + '/' + f'_model_{args.model}_'+ str(args.optim_lr), exist_ok=True)
    os.makedirs(args.img_save_dir + '/' + f'_model_{args.model}_'+ str(args.optim_lr), exist_ok=True)
    args.log_dir = args.log_dir + '/' + f'_model_{args.model}_'+ str(args.optim_lr)
    args.img_save_dir = args.img_save_dir + '/' + f'_model_{args.model}_'+ str(args.optim_lr)
    ...
    accuracy = run_ddim_hdae_training_seg(model,
