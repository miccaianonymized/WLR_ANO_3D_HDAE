...
def train_ddim_hdae_epoch(model,
                          ema_model,
                          scheduler,
                          inferer,
                          train_loader,
...
import json
import shutil
def run_ddpm_hae_training_ddpm(model,
                               train_loader,
                               val_loader,
                               optimizer,
                               lr_scheduler,
    ...
    for epoch in range(n_epochs):
        ...
        epoch_tr_loss = train_ddim_hdae_epoch(model,
                                              ema_model,
                                              scheduler,
                                              inferer,
                                              train_loader,
        ...
        b_new_best = False
        epoch_val_loss = val_ddim_hdae_epoch(model,
                                             ema_model,
                                             inferer,
                                             val_loader,
                                             scheduler,
